---
title: "SimulationAG1AG2PoissonGLM_Weighted_Gradient"
author: "Xiangni Peng"
output: pdf_document
---
...
# Create an initial matrix to store all the simulation results
sim_results_mse_mat111_unweighted <- matrix(NA_real_,nrow = num_sim,ncol = K)
...
for (sim_i in 1:num_sim){
  ...
  for (k in 1:K){
    beta_path[k+1, ] <- update_beta_AG1_not_weighted(as.numeric(beta_path[k,]),eta,
                                       mu,client_Bi,K,clients_sim_i,client_ni_11)
    mse_path[k+1] <- mse_beta(as.numeric(beta_path[k+1,]),beta_true)
  }
  
  # Store the results
  sim_results_mse_mat111_unweighted[sim_i, ] <- mse_path[-1]
}
```

```{r,echo=FALSE,include=FALSE}
# Plot mse vs k
plot_mse_path_unweighted <- colMeans(sim_results_mse_mat111_unweighted)
plot(1:K, plot_mse_path_unweighted, type = "l", lwd = 2,
     xlab = "Iteration k",
     ylab = "MSE of beta_k",
     main = "n_i = 50, Algorithm 1")
legend("topright", legend = c("beta_0 = 0, unweighted"), bty = "n")
```

```{r,echo=FALSE}
matplot(1:K, cbind(plot_mse_path, plot_mse_path_unweighted),
        type = "l", lty = 1, lwd = 2, col = c("blue", "red"),
        xlab = "Iteration k", ylab = "MSE of beta_k", 
        main = "n_i=50, Algorithm 1, beta_0 = 0"
       )

legend("topright", legend = c("Weighted gradient", "Unweighted gradient"),
...
```{r,echo=FALSE,include=FALSE}
# Create an initial matrix to store all the simulation results
sim_results_mse_mat121_not_weighted <- matrix(NA_real_,nrow = num_sim,ncol = K)
...
for (sim_i in 1:num_sim){
  ...
  # Store the results
  sim_results_mse_mat121_not_weighted[sim_i, ] <- mse_path[-1]
}
```

```{r,echo=FALSE,include=FALSE}
# Plot mse vs k
plot_mse_path_not_weighted <- colMeans(sim_results_mse_mat121_not_weighted)
plot(1:K, plot_mse_path_not_weighted, type = "l", lwd = 2,
     xlab = "Iteration k",
     ylab = "MSE of beta_k",
     main = "n_i = sample[20:80], Algorithm 1")
legend("topright", legend = c("beta_0 = 0, unweighted"), bty = "n")
...
```{r,echo=FALSE}
matplot(1:K, cbind(plot_mse_path121, plot_mse_path_not_weighted),
        type = "l", lty = 1, lwd = 2, col = c("blue","red"),
        xlab = "Iteration k", ylab = "MSE of beta_k",
        main = "n_i = sample[20:80], Algorithm 1, beta_0 = 0"
       )
...
```{r,echo=FALSE,include=FALSE}
# Define \betaˆ{k+1} in Algorithm 1 applied in stage II of Algorithm 2
update_beta_AG1_in_AG2_unweighted <- function(last_beta,eta,mu,client_Bi,K,client_list,client_ni){
...
```{r,echo=FALSE,include=FALSE}
AG1_in_AG2_unweighted <- function(client_list, client_ni, K2, eta2, mu, beta_0) {
  ...
  # K2 iterations
    for (k in 1:K2){
    beta_path[k+1, ] <- update_beta_AG1_in_AG2_unweighted(as.numeric(beta_path[k,]),eta2,
                                       mu,client_Bi,K2,client_list,client_ni)
  }
...
```{r,echo=FALSE,include=FALSE}
# Store the simulation results
server_beta_K2_mse_sim_result_21_unweighted <- matrix(NA_real_, nrow = num_sim, ncol = K2)
...
for (sim_i in 1:num_sim){
  ...
  # Stage II: Run Algorithm 1 for K2 iterations with the private initialization
  beta_path_stageII <- AG1_in_AG2_unweighted(clients_sim_i, client_ni_21, K2, 
                                  eta_2, mu, beta_0_stageII)
  ...
  server_beta_K2_mse_sim_result_21_unweighted[sim_i, ] <- mse_path
}
```

```{r,echo=FALSE,include=FALSE}
# Plot mse vs k
plot_mse_path21_unweighted <- colMeans(server_beta_K2_mse_sim_result_21_unweighted)
plot(1:K2, plot_mse_path21_unweighted, type = "l", lwd = 2,
     xlab = "Iteration k",
     ylab = "MSE of beta_k",
     main = "n_i = 50, Algorithm 2")
legend("topright", legend = c("Unweighted"), bty = "n")
```

```{r,echo=FALSE}
matplot(1:K2, cbind(plot_mse_path21,plot_mse_path21_unweighted),
        type = "l", lty = 1, lwd = 2, col = c("blue","red"),
        xlab = "Iteration k", ylab = "MSE of beta_k",
        main = "n_i = 50, Algorithm 2"
        )
...
```{r,echo=FALSE,include=FALSE}
# Store the simulation results
server_beta_K2_mse_sim_result_22_unweighted <- matrix(NA_real_, nrow = num_sim, ncol = K2)
...
for (sim_i in 1:num_sim){
  ...
  # Stage II: Run Algorithm 1 for K2 iterations with the private initialization
  beta_path_stageII <- AG1_in_AG2_unweighted(clients_sim_i, client_ni_22, K2, 
                                  eta_2, mu, beta_0_stageII)
  ...
  server_beta_K2_mse_sim_result_22_unweighted[sim_i, ] <- mse_path
}
```

```{r,echo=FALSE,include=FALSE}
# Plot mse vs k
plot_mse_path22_unweighted <- colMeans(server_beta_K2_mse_sim_result_22_unweighted)
plot(1:K2, plot_mse_path22_unweighted, type = "l", lwd = 2,
     xlab = "Iteration k",
     ylab = "MSE of beta_k",
     main = "n_i = sample[20:80], Algorithm 2")
legend("topright", legend = c("unweighted"), bty = "n")
...
```{r, echo=FALSE}
matplot(1:K2, cbind(plot_mse_path22,plot_mse_path22_unweighted),
        type = "l", lty = 1, lwd = 2, col = c("blue","red"),
        xlab = "Iteration k", ylab = "MSE of beta_k",
        main = "n_i = sample[20:80], Algorithm 2"
        )
